...
class RectangleTest(unittest.TestCase):
    ...
    def test_14_1(self):
        ...
        s = Square(10, 10, 10, 10)
        self.assertEqual(s.to_dictionary(), {"x": 10, "y": 10, "id": 10, "size": 10})

    def test_14_2(self):
        """Tests for to_dictionary method"""
        s = Square(10, 10, 10, 10)
        s.update(id=5, size=3, x=3)
        self.assertEqual(s.to_dictionary(), {"x": 3, "y": 10, "id": 5, "size": 3})
    ...
    def test_14_4(self):
        ...
        self.set_zero()
        s1 = Square(5, 2)
        self.assertEqual(s1.to_dictionary(), {"x": 2, "y": 0, "id": 1, "size": 5})
